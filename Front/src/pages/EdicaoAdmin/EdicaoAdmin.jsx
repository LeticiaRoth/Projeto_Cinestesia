          ...
          <div className="infoBox">
            ...
            <ul className="infoLista">
              ...
              <li className="infoItem">
                ...
                <span className="infoDado">{filme.diretor}</span>
              </li>
              <li className="infoItem">
                <span className="infoLabel">ATOR PRINCIPAL:</span>
                <span className="infoDado">{filme.elenco}</span>
              </li>
              <li className="infoItem">
              ...
              <li className="infoItem">
                <span className="infoLabel">PAÍS:</span>
                <span className="infoDado">{filme.pais}</span>
              </li>
  ...
  return (
    <div className="paginaInfoFilme">
      <div className="containerPaginaInfo">
        <Link to="/verFilmes" className="botaoVoltarCatalogo">
          VOLTAR AO CATÁLOGO
        </Link>
        {renderizarConteudo()}
      </div>
